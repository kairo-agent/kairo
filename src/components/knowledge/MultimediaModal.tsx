...
export function MultimediaModal({ items, onAdd, onDelete, isSaving, isLoading }: MultimediaModalProps) {
  // Add form state
          ...
          {items.map((item) => (
            ...
            >
              ...
              <button
                ...
                className="flex-shrink-0 p-1.5 rounded-md text-[var(--text-tertiary)] hover:text-red-500 hover:bg-red-500/10 opacity-0 group-hover:opacity-100 transition-all"
                title={labels.remove}
              >
