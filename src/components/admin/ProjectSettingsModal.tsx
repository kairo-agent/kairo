...
export default function ProjectSettingsModal({
  ...
  // Tabs
  const [activeTab, setActiveTab] = useState<'agents' | 'whatsapp' | 'channels'>('agents');
  ...
  const tabs = [
    ...
    { id: 'channels' as const, label: 'Canales', icon: <ChannelsIcon /> },
  ];
  ...
  return (
    ...
    >
      <div className="space-y-6">
        ...
        {/* Tab Content: Canales (Fase 2.1) */}
        {activeTab === 'channels' && project?.id && (
          <ProjectChannelsTab
            projectId={project.id}
