  ...
  return (
    <Modal isOpen={isOpen} onClose={handleClose} title={t('export.title')} size="sm">
      <div className="flex flex-col gap-4">
        ...
        <div className="flex gap-3" ref={pickerRef}>
          {/* From */}
        ...
        {/* Calendar picker (one at a time) */}
        {activePicker && (
          <div className="export-date-picker rounded-xl border border-[var(--border-primary)] bg-[var(--bg-primary)] overflow-hidden">
