...
export const LEAD_STATUS_CONFIG: Record<LeadStatus, { label: string; color: string; bgColor: string }> = {
  ...
  [LeadStatus.UNQUALIFIED]: { label: 'No Calificado', color: '#78716C', bgColor: 'rgba(120, 113, 108, 0.1)' },
  [LeadStatus.NO_RESPONSE]: { label: 'Sin Respuesta', color: '#94A3B8', bgColor: 'rgba(148, 163, 184, 0.1)' },
